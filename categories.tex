...
\begin{prop}
    ...
    More specifically, let $i : A \rightarrow A$. Then the following are equivalent:
    \begin{enumerate}
    \item For every object $B$ and morphism $f : A \rightarrow B$ we have $f \circ i = f$.
    \item For every object $B$ and morphism $f : B \rightarrow A$ we have $i \circ f = f$.
    \item For every morphism $f : A \rightarrow A$ we have $f \circ i = f$.
    \item For every morphism $f : A \rightarrow A$ we have $i \circ f = f$.
    \item $\id{A} \circ i = \id{A}$
    \item $i \circ \id{A} = i$
    \item $i = \id{A}$
    \end{enumerate}
\end{prop}
...
\begin{proof}
    \pf\ $1 \Rightarrow 3 \Rightarrow 5 \Rightarrow 7 \Rightarrow 1$ and $2 \Rightarrow 4 \Rightarrow 6 \Rightarrow 7 \Rightarrow 2$ are all trivial. \qed
\end{proof}
