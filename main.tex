...
\begin{prop}
Let $E \subseteq \mathbb{R}^k$ be uncountable. Let $P$ be the set of condensation points of $E$. Then $E - P$ is countable.
\end{prop}

\begin{proof}
\pf
\step{1}{\pick\ a countable basis $\mathcal{B}$ for $\mathbb{R}^k$.}
\step{2}{\pflet{$W = \bigcup \{ B \in \mathcal{B} : E \cap B \text{ is countable} \}$}}
\step{3}{$P = \mathbb{R}^k - W$}
\begin{proof}
	\step{a}{$P \subseteq \mathbb{R}^k - W$}
	\begin{proof}
		...
		\end{proof}
	\end{proof}
	\step{b}{$\mathbb{R}^k - W \subseteq P$}
	\begin{proof}
		\step{i}{\pflet{$p \in \mathbb{R}^k - W$}}
