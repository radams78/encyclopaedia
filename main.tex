...
\begin{prop}
If $a \in A$ and $A$ is grounded, then $a$ is grounded and $\rank a < \rank A$.
\end{prop}

\begin{proof}
\pf
\step{1}{$A \in \mathcal{P} V_{\rank A}$}
\begin{proof}
	\pf\ $A \in V_{(\rank A)^+} = \mathcal{P} V_{\rank A}$.
\end{proof}
\step{2}{$a \in V_{\rank A}$}
\step{3}{$a$ is grounded and $(\rank a)^+ \leq \rank A$}
\qed
\end{proof}
