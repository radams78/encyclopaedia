...
\begin{prop}
Let $E \subseteq \mathbb{R}^k$ be uncountable. Let $P$ be the set of condensation points of $E$. Then $P$ is perfect.
\end{prop}
...
\step{1}{$P$ is closed.}
\begin{proof}
	\step{a}{\pflet{$p \in \mathbb{R}^k - P$}}
	...
	\step{d}{$p \in U \subseteq \mathbb{R}^k - P$}
\end{proof}
