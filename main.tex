...
\step{2}{\pflet{$x \in \bigcup \mathcal{U}$}}
\step{3}{\pick\ $U \in \mathcal{U}$ such that $x \in U$.}
\step{4}{\pick\ $\epsilon > 0$ such that $B(x, \epsilon) \subseteq U$}
\step{5}{$B(x, \epsilon) \subseteq \bigcup \mathcal{U}$}
\qed
\end{proof}
...
\step{2}{\pflet{$x \in U \cap V$}}
\step{3}{\pick\ $\delta > 0$ such that $B(x, \delta) \subseteq U$ and $\epsilon > 0$ such that $B(x, \epsilon) \subseteq V$.}
\step{4}{\assume{w.l.o.g. $\delta \leq \epsilon$}}
\step{5}{$B(x,\delta) \subseteq U \cap V$}
\qed
\end{proof}
...
\begin{prop}
The space $l^2$ in complete.
\end{prop}

\begin{proof}
\pf
\step{1}{\pflet{$(a_n)$ be a Cauchy sequence in $l^2$.}}
...
\[ \sum_{k=0}^\infty | \alpha_{mk} - \alpha_{nk} |^2 < \epsilon \enspace . \]}
\begin{proof}
	\pf\ \stepref{1}
\end{proof}
...
\[ \sum_{k=0}^\infty | \alpha_k - \alpha_{nk} |^2 < \epsilon \enspace . \]}
\begin{proof}
	\pf\ Take the limit $m \rightarrow \infty$ in \stepref{4}.
\end{proof}
\step{8}{$a \in l^2$}
\begin{proof}
	\step{a}{\pick\ $N$ such that $\forall n \geq N. \sum_{k=0}^\infty |\alpha_k - \alpha_{nk} |^2 < 1$}
	\step{b}{$a - a_N \in l^2$}
	\qedstep
	\begin{proof}
		\pf\ Since $l^2$ is closed under $+$.
	\end{proof}
\end{proof}
