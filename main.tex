...
A set $A$ is a \emph{transitive set} iff whenever $x \in y \in A$ then $x \in A$.
\end{df}
...
\begin{proof}
	\pf\ If $n$ is a transitive set then $\bigcup(n^+) = n \subseteq n^+$ by Proposition \ref{prop:Uaplus} and so $n^+$ is a transitive set.
