...
\step{2}{\assume{$\beta < \delta^\omega$}}
\step{3}{\pick\ $n < \omega$ such that $\beta < \delta^n$}
\step{4}{$\beta + \delta^\omega \leq \beta + \gamma$}
\begin{proof}
	\pf
	\begin{align*}
		\beta + \delta^\omega & \leq \delta^n + \delta^\omega \\
		& \leq \delta^\omega + \delta^\omega \\
		& = 2 \delta^\omega \\
		& \leq \delta \delta^\omega \\
		& = \delta^{1 + \omega} \\
		& = \delta^\omega \\
		& = \beta + \gamma
	\end{align*}
\end{proof}
\step{5}{$\delta^\omega \leq \gamma$}
\step{6}{$\gamma = \delta^\omega$}
\qed
\end{proof}
