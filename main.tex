...
For any classes $\mathbf{A}$ and $\mathbf{B}$, if $\mathbf{A} \subseteq \mathbf{B}$ then $\mathcal{P} \mathbf{A} \subseteq \mathcal{P} \mathbf{B}$.
\end{prop}

\begin{proof}
\pf\ For any set $X$, if $X \subseteq \mathbf{A}$ then $X \subseteq \mathbf{B}$. \qed
\end{proof}

\begin{prop}
\label{prop:UPA}
For any class $\mathbf{A}$ we have $\bigcup \mathcal{P} \mathbf{A} = \mathbf{A}$.
\end{prop}

\begin{proof}
\pf
\step{1}{$\bigcup \mathcal{P} \mathbf{A} \subseteq \mathbf{A}$}
\begin{proof}
...
\end{proof}
\step{2}{$\mathbf{A} \subseteq \bigcup \mathcal{P} \mathbf{A}$}
\begin{proof}
...
Let $\mathbf{A}$ be a class. Then the following are equivalent.
\begin{enumerate}
\item
...
\begin{prop}
For any class $\mathbf{A}$, we have $\mathbf{A}$ is a transitive class if and only if $\mathcal{P} \mathbf{A}$ is a transitive class.
\end{prop}
...
\begin{df}[Relation]
A \emph{relation} between classes $\mathbf{A}$ and $\mathbf{B}$ is a subclass of $\mathbf{A} \times \mathbf{B}$.
\end{df}
