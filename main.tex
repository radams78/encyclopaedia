...
\begin{proof}
\pf
\step{1}{$\cf \aleph_\lambda \leq \cf \lambda$}
\begin{proof}
	...
	\end{proof}
\end{proof}
\step{2}{$\cf \lambda \leq \cf \aleph_\lambda$}
\begin{proof}
	\step{a}{\pick\ a set $A$ of ordinals $< \aleph_\lambda$ such that $|A| = \cf \aleph_\lambda$ and $\sup A = \aleph_\lambda$}
	\step{b}{\pflet{$B = \{ \gamma < \lambda \mid \exists \alpha \in A. |\alpha| = \aleph_\gamma \}$}}
	\step{c}{$|B| \leq |A| = \cf \aleph_\lambda$ \prove{$\sup B = \lambda$}}
	\step{d}{$\forall \alpha \in A. |\alpha| \leq \aleph_{\sup B}$}
	\step{e}{$\forall \alpha \in A. \alpha < \aleph_{\sup B + 1}$}
	\step{f}{$\aleph_\lambda = \sup A \leq \aleph_{\sup B + 1}$}
