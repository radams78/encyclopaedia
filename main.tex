...
\begin{thm}[Root Test]
Let $(a_n)_{n \geq 1}$ be a sequence of complex numbers. Let $\alpha = \limsup_{n \rightarrow \infty} |a_n|^{1/n}$.
\begin{enumerate}
...
Let $(a_n)_{n \geq 0}$ be a sequence of complex numbers.
\begin{enumerate}
\item If
\[ \limsup_{n \rightarrow \infty} \left| \frac{a_{n+1}}{a_n} \right| < 1 \]
then $\sum_{n=0}^\infty a_n$ converges.
\item If there exists $N$ such that $\forall n \geq N. \left| \frac{a_{n+1}}{a_n} \right| > 1$ then
...
\begin{proof}
\pf
\step{1}{If $\limsup_{n \rightarrow \infty} \left| \frac{a_{n+1}}{a_n} \right| < 1$
then $\sum_{n=0}^\infty a_n$ converges.}
\begin{proof}
	\step{a}{\assume{$\limsup_{n \rightarrow \infty} \left| \frac{a_{n+1}}{a_n} \right| < 1$}}
	...
	\end{proof}
\end{proof}
\step{2}{If there exists $N$ such that $\forall n \geq N. \left| \frac{a_{n+1}}{a_n} \right| > 1$ then
$\sum_{n=0}^\infty a_n$ diverges.}
\begin{proof}
	\pf\ Since $a_n \nrightarrow 0$ as $n \rightarrow \infty$.
\end{proof}
...
\begin{thm}
Let $(a_n)$, $(b_n)$ be two sequences of complex numbers. Let
