...
\begin{thm}
Let $U$ and $V$ be normed spaces. Let $W$ be a closed subspace of $U$ and $T : W \rightarrow V$ be a continuous linear transformation. Then the graph of $T$, $G = \{ (x,T(x)) \mid x \in W \}$, is closed in $U \times V$.
\end{thm}

\begin{proof}
\pf
\step{1}{\pflet{$((x_n, T(x_n)))$ be a sequence in $G$.}}
...
\begin{proof}
	\pf
	\begin{align*}
		y & = \lim_{n \rightarrow \infty} T(x_n) \\
		& = T \left( \lim_{n \rightarrow \infty} x_n \right) \\
		& = T(x)
	\end{align*}
\end{proof}
\qed
