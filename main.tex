...
\begin{prop}
The trace of a linear operator is independent of the choice of basis.
\end{prop}

\begin{proof}
\pf
\step{1}{\pflet{$\{ \ket{e_1}, \ldots, \ket{e_n} \}$ and $\{ \ket{f_1}, \ldots, \ket{f_n} \}$ be two orthonormal bases.}}
\step{2}{$\sum_i \langle e_i \mid T \mid e_i \rangle = \sum_j \langle f_i \mid T \mid f_i \rangle$}
\begin{proof}
	\pf
	\begin{align*}
		\sum_i \langle e_i \mid T \mid e_i \rangle
		& = \sum_{i,j,k} \langle e_i \mid f_j \rangle \langle f_j \mid T \mid f_k \rangle \langle f_k \mid e_i \rangle \\
		& = \sum_{j,k} \langle f_k \mid f_j \rangle \langle f_j \mid T \mid f_k \rangle \\
		& = \sum_j \langle f_j \mid T \mid f_j \rangle
	\end{align*}
\end{proof}
\qed
\end{proof}
...
\begin{proof}
\pf
\step{1}{$\langle (\Delta A)^2 \rangle \langle (\Delta B)^2 \rangle \geq | \langle \Delta A \Delta B \rangle |^2$}
\begin{proof}
\pf
\begin{align*}
...
\end{align*}
\end{proof}
\step{2}{$\Delta A \Delta B = \frac{1}{2}[\Delta A, \Delta B] + \frac{1}{2} \{ \Delta A, \Delta B \}$}
\step{3}{$[\Delta A, \Delta B] = [A,B]$}
\begin{proof}
	\pf
	\begin{align*}
...
\begin{proof}
	...
	\end{align*}
\end{proof}
\step{4}{$\langle \Delta A \Delta B \rangle = \frac{1}{2} \langle [A,B] \rangle + \frac{1}{2} \langle \{ \Delta A , \Delta B \} \rangle$}
\step{5}{$\langle [A,B] \rangle$ is purely imaginary.}
\step{6a}{$\{ \Delta A, \Delta B \}$ is Hermitian.}
\begin{proof}
	\pf
	\begin{align*}
	...
	\end{align*}
\end{proof}
\step{6}{$\langle \{ \Delta A, \Delta B \}\rangle$ is real.}
\step{7}{$|\langle \Delta A \Delta B \rangle|^2 = \frac{1}{4} |\langle [A,B] \rangle|^2 + \frac{1}{4}| \langle \{ \Delta A , \Delta B \} \rangle |^2$}
\begin{proof}
	\pf\ From \stepref{4}, \stepref{5} and \stepref{6}.
\end{proof}
\step{8}{\[ \langle (\Delta A)^2 \rangle \langle (\Delta B)^2 \rangle \geq \frac{1}{4} |\langle [A,B] \rangle|^2 \enspace . \]}
\begin{proof}
	\pf\ From \stepref{1} and \stepref{7}.
\end{proof}
\qed
\end{proof}
