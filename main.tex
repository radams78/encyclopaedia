...
\begin{proof}
	...
	\step{b}{\pick\ $\beta < 1$ and $N$ such that $\forall n \geq N$
	\[ \left| \frac{a_{n+1}}{a_n} \right| < \beta \enspace . \]}
	\begin{proof}
		\pf\ Theorem \ref{thm:greater_than_limsup}.
	\end{proof}
	\step{c}{For all $n > N$ we have
	\[ |a_n| < |a_N| \beta^{-N} \beta^n \enspace . \]}
	\begin{proof}
		\pf\ By induction on $n$.
	\end{proof}
	\step{d}{$\sum_n \beta^n$ converges.}
	\begin{proof}
		\pf\ Theorem \ref{thm:geometric_series}.
	\end{proof}
	\step{e}{$\sum_n a_n$ converges.}
	\begin{proof}
		\pf\ Comparison Test.
	\end{proof}
\end{proof}
