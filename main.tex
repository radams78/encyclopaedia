...
\begin{prop}
The Axiom of Pairing is a theorem of SF.
\end{prop}
...
\begin{thms}[Transfinite Induction Principle (S)]
For any classes $\mathbf{A}$, $\mathbf{B}$ and $\mathbf{R}$, the following is a theorem:
...
\begin{thms}[Transfinite Recursion Theorem Schema (ZF)]
...
\begin{proof}
	...
	\step{c}{\pflet{$E = \{ (x,y) \in \alpha^2 \mid x \in y \}$}}
	\step{d}{$\forall x,y,z \in \alpha. x E y \wedge y E z \Rightarrow x E z$}
	\begin{proof}
		\step{i}{\pflet{$x,y,z \in \alpha$}}
		\step{ii}{\assume{$xEy$ and $yEz$}}
		\step{iii}{$x \in z$ or $x = z$ or $z \in x$}
		\step{iv}{$x \neq z$}
		\begin{proof}
			\pf\ We cannot have $x \in y \in x$ by the Axiom of Foundation.
		\end{proof}
		\step{v}{$z \notin x$}
		\begin{proof}
			\pf\ We cannot have $x \in y \in z \in x$ by the Axiom of Foundation.
		\end{proof}
		\step{vi}{$x \in z$}
	\end{proof}
	\step{e}{There is no $x \in \alpha$ such that $x E x$.}
	\begin{proof}
		\pf\ Axiom of Foundation.
	\end{proof}
	\step{f}{Every nonempty subset of $\alpha$ has an $E$-least element.}
	\begin{proof}
		\pf\ Axiom of Foundation.
	\end{proof}
\end{proof}
...
\begin{proof}
	...
	\step{b}{\pick\ $u \in \beta - \alpha$ such that $u \cap (\beta - \alpha) = \emptyset$}
	\begin{proof}
		\pf\ Axiom of Foundation.
	\end{proof}
	\step{c}{$u \in \beta$}
...
\end{proof}
\step{2}{$\forall y,z \in \bigcap x. y \in z \vee y = z \vee z \in y$}
\begin{proof}
	\step{a}{\pick\ $\alpha \in x$}
	\step{b}{$y,z \in \alpha$}
	\step{c}{$y \in z$ or $y = z$ or $z \in y$}
\end{proof}
\qed
\end{proof}
...
\begin{cor}[Burali-Forti Paradox (S)]
The class $\mathbf{On}$ is a proper class.
\end{cor}

\begin{proof}
\pf\ If $\mathbf{On}$ is a set then it is an ordinal by Propositions \ref{prop:Ontransitive} and \ref{prop:ordtrichotomy}, hence $\mathbf{On} \in \mathbf{On}$ contradicting the Axiom of Foundation. \qed
\end{proof}

\begin{thm}[S]
The class $\mathbf{On}$ is well ordered by $\leq$.
\end{thm}

\begin{proof}
\pf
\step{1}{For every ordinal $\alpha$ we have $\alpha \leq \alpha$.}
\begin{proof}
	\pf\ Immediate from definition.
\end{proof}
\step{2}{For any ordinals $\alpha$, $\beta$ and $\gamma$, if $\alpha \leq \beta \leq \gamma$ then $\alpha \leq \gamma$.}
\begin{proof}
	\pf\ Since $\gamma$ is a transitive set.
\end{proof}
\step{3}{For any ordinals $\alpha$ and $\beta$, if $\alpha \leq \beta \leq \alpha$ then $\alpha = \beta$.}
\begin{proof}
	\pf\ If $\alpha \neq \beta$ then $\alpha \in \beta \in \alpha$ contradicting the Axiom of Foundation.
\end{proof}
\step{4}{For any ordinals $\alpha$ and $\beta$, either $\alpha \leq \beta$ or $\beta \leq \alpha$.}
\begin{proof}
	\pf\ Theorem \ref{thm:ordinaltrichotomy}.
\end{proof}
\step{5}{Any set of ordinals $x$ has a least element.}
\begin{proof}
	\pf\ Axiom of Foundation.
\end{proof}
\qed
...
\begin{proof}
	...
	\end{proof}
	\step{b}{For all $y,z \in \bigcup x$ we have $y \in z$ or $y = z$ or $z \in y$}
	\begin{proof}
		\step{i}{\pick\ $\alpha, \beta \in x$ such that $y \in \alpha$ and $z \in \beta$.}
		\step{ii}{\assume{w.l.o.g. $\alpha \leq \beta$.}}
		\step{iii}{$y,z \in \beta$}
		\step{iv}{$y \in z$ or $y = z$ or $z \in y$.}
	\end{proof}
\end{proof}
\qed
\end{proof}
...
\begin{proof}
	...
	\step{d}{$x \in \alpha^+$}
\end{proof}
\step{2}{For any $x,y \in \alpha^+$, we have $x \in y$ or $x = y$ or $y \in X$.}
\begin{proof}
	\step{a}{\pflet{$x,y \in \alpha^+$}}
	\step{b}{\case{$x \in \alpha$ and $y \in \alpha$}}
	\begin{proof}
		\pf\ Then $x \in y$ or $x = y$ or $y \in x$ because $\alpha$ is an ordinal.
	\end{proof}
	\step{c}{\case{$x \in \alpha$ and $y = \alpha$}}
	\begin{proof}
		\pf\ Then $x \in y$.
	\end{proof}
	\step{d}{\case{$x = \alpha$ and $y \in \alpha$}}
	\begin{proof}
		\pf\ Then $y \in x$.
	\end{proof}
	\step{e}{\case{$x = \alpha$ and $y = \alpha$}}
	\begin{proof}
		\pf\ Then $x = y$.
	\end{proof}
\end{proof}
...
\begin{thms}[Mathematical Induction (S)]
...
\begin{proof}
	...
	\end{proof}
\end{proof}
\step{2}{For all $m,n \in \omega$, either $m \in n$ or $m = n$ or $n \in m$.}
\begin{proof}
	\pf\ Theorem \ref{thm:ordinaltrichotomy}.
\end{proof}
\step{3}{$\omega \neq 0$}
...
The relation $\{ (x,y) \in \mathbf{A}^2 \mid x \in y \}$ is well founded.
\end{props}

\begin{proof}
\pf
\step{1}{Every nonempty set has an $\in$-minimal element.}
\begin{proof}
	\pf\ This is the Axiom of Foundation.
\end{proof}
\step{2}{For any set $x$, there exists $u$ such that $x \subseteq u$ and for all $w$, $y$, if $y \in u$ and $w,y \in \mathbf{A}$ and $w \in y$ then $w \in u$}
\begin{proof}
	\pf\ Take $u = \mathrm{TC}(x)$.
\end{proof}
\qed
\end{proof}
