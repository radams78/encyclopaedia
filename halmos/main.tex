...
\begin{df}[Function]
Let $X$ and $Y$ be sets. A \emph{function from $X$ to $Y$} is a relation $f$ between $X$ and $Y$ such that, for all $x \in X$, there exists a unique $f(x) \in Y$ such that $(x,f(x)) \in f$.
\end{df}
