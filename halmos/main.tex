...
\begin{proof}
\pf
\step{1}{\pflet{$f : \omega \rightarrow \omega$ be the function $f(n) = n + 1$}}
\step{2}{$f$ is a one-to-one correspondence between $\omega$ and $\omega - \{0\}$}
\step{3}{\assume{for a contradiction $n \in \omega$ and $g$ is a one-to-one correspondence between $\omega$ and $n$.}}
\step{4}{$g \restriction (\omega - \{0\}) \circ f \circ g^{-1}$ is a one-to-one correspondence between $n$ and $n - \{ g(0) \}$}
\qedstep
\begin{proof}
	\pf\ This contradicts Proposition \ref{prop:pigeonhole}.
\end{proof}
\qed
\end{proof}
