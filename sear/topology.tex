...
We prove this is a topology on $X$.
\end{df}

\begin{proof}
\pf
\step{1}{For any $\mathcal{U} \subseteq \mathcal{P} X$ we have $\bigcup \mathcal{U} \in \mathcal{P} X$.}
\begin{proof}
	\pf\ Trivial.
\end{proof}
\step{2}{For any $U,V \in \mathcal{P} X$ we have $U \cap V \in \mathcal{P} X$.}
\begin{proof}
	\pf\ Trivial.
\end{proof}
\step{3}{$X \in \mathcal{P} X$}
\begin{proof}
	\pf\ Trivial.
\end{proof}
\qed
...
\begin{proof}
	\step{a}{\pflet{$\mathcal{U} \subseteq \mathcal{T}$}}
	\step{b}{\case{$\mathcal{U} \subseteq \{ \emptyset\}$}}
	\begin{proof}
		\pf\ Then $\bigcup \mathcal{U} = \emptyset \in \mathcal{T}$.
	\end{proof}
	\step{c}{\case{$\mathcal{U} \nsubseteq \{\emptyset\}$}}
	\begin{proof}
		\step{i}{\pick\ a nonempty $U \in \mathcal{U}$}
		\step{ii}{$X - \bigcup \mathcal{U} \subseteq X - U$}
		\step{iii}{$X - U$ is finite.}
		\step{iv}{$X - \bigcup \mathcal{U}$ is finite.}
		\step{v}{$\bigcup \mathcal{U} \in \mathcal{T}$}
	\end{proof}
\end{proof}
\step{2}{For all $U,V \in \mathcal{T}$ we have $U \cap V \in \mathcal{T}$.}
\begin{proof}
	\step{a}{\pflet{$U,V \in \mathcal{T}$}}
	\step{b}{\case{$U = \emptyset$ or $V = \emptyset$}}
	\begin{proof}
