...
\begin{proof}
\pf
\step{1}{For all $y \in Y$, there exist neighbourhoods $U$ of $x_0$ and $V$ of $y$ such that $U \times V \subseteq N$.}
\step{2}{$\{ V \text{ open in } Y : \exists U \text{ open in } X. x_0 \in U \wedge U \times V \subseteq N \}$ is an open cover of $Y$.}
\step{3}{\pick\ a finite subcover $\{V_1, \ldots, V_n\}$.}
\step{4}{For $i = 1, \ldots, n$, \pick\ a neighbourhood $U_i$ of $x_0$ such that $U_i \times V_i \subseteq N$.}
\step{5}{\pflet{$W = U_1 \cap \cdots \cap U_n$}}
\step{6}{$W$ is open.}
\step{7}{$x_0 \in W$}
\step{8}{$W \times Y \subseteq N$}
\qed
\end{proof}
