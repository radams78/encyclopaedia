...
\step{2}{For every $x_0 \in X$ and $N$ an open set that includes $\{ x_0 \} \times Y$, there exists a neighbourhood $W$ of $x_0$ such that $W \times Y \subseteq N$.}
\begin{proof}
	\step{a}{\pflet{$x_0 \in X$}}
	\step{b}{\pflet{$N$ be an open set that includes $\{x_0\} \times Y$.}}
	\step{c}{For all $y \in Y$, there exist neighbourhoods $U$ of $x_0$ and $V$ of $y$ such that $U \times V \subseteq N$.}
	\step{d}{$\{ V \text{ open in } Y : \exists U \text{ open in } X. x_0 \in U \wedge U \times V \subseteq N \}$ is an open cover of $Y$.}
	\step{e}{\pick\ a finite subcover $\{ V_1, \ldots, V_n \}$}
	\step{f}{For $i = 1, \ldots, n$, \pick\ a neighbourhood $U_i$ of $x_0$ such that $U_i \times V_i \subseteq N$.}
	\step{g}{\pflet{$W = U_1 \cap \cdots \cap U_n$}}
	\step{h}{$W$ is open.}
	\step{i}{$x_0 \in W$}
	\step{j}{$W \times Y \subseteq N$}
\end{proof}
