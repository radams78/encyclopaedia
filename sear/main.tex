...
\begin{proof}
\pf
\step{1}{\pflet{$\mathcal{A}$ be a set of connected subspaces of $X$ that have a point in common.}}
\step{2}{\pick\ $a$ such that $a \in \bigcap \mathcal{A}$}
\step{3}{\assume{for a contradiction $(A,B)$ is a separation of $\bigcup \mathcal{A}$.}}
\step{3}{\assume{w.l.o.g. $a \in A$}}
\step{4}{For all $Y \in \mathcal{A}$ we have $Y \subseteq A$}
\begin{proof}
...
\begin{cor}
$\mathbb{R}^\omega$ under the product topology is connected.
\end{cor}

\begin{proof}
\pf\ It is the closure of $\mathbb{R}^\infty$, which is connected because it is the union of the connected subspaces $\mathbb{R}^n$. \qed
\end{proof}
