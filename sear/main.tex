...
\begin{ex}
The subspace topology on a subset of a linearly ordered set under the order topology is not necessarily the order topology induced by the restriction of the order.
