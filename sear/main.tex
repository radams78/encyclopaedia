...
\begin{prop}
In a Hausdorff space, every one-point set is closed.
\end{prop}
...
\begin{cor}
In a Hausdorff space, every finite set is closed.
\end{cor}

\begin{ex}
The converse does not hold. If $X$ is an infinite set under the cofinite topology, then every one-point set is closed, but $X$ is not Hausdorff.
\end{ex}
