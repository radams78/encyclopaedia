...
Let $X$ be a first countable space. Let $A \subseteq X$. Let $l \in \overline{A}$. Then there exists a sequence in $A$ that converges to $l$.
\end{prop}

\begin{proof}
\pf
\step{1}{\pick\ a countable basis $\{ U_n : n \in \mathbb{N} \}$ at $l$.}
\step{2}{For $n \in \mathbb{N}$, \pick\ $x_n \in U_0 \cap \cdots \cap U_n \cap A$. \prove{$x_n \rightarrow l$ as $n \rightarrow \infty$.}}
\step{3}{\pflet{$V$ be a neighbourhood of $l$.}}
\step{4}{\pick\ $N$ such that $U_N \subseteq V$.}
\step{5}{$\forall n \geq N. x_n \in V$}
\qed
\end{proof}
...
\begin{prop}
Let $X$ be a first countable space and $Y$ a topological space. Let $f : X \rightarrow Y$. Assume that, whenever $x_n \rightarrow l$ as $n \rightarrow \infty$ in $X$, then $f(x_n) \rightarrow f(l)$ as $n \rightarrow \infty$ in $Y$. Then $f$ is continuous.
\end{prop}

\begin{proof}
\pf
\step{1}{\pflet{$A \subseteq X$} \prove{$f(\overline{A}) \subseteq \overline{f(A)}$}}
\step{2}{\pflet{$l \in \overline{A}$}}
\step{3}{\pick\ a sequence $(x_n)$ in $A$ that converges to $l$.}
\step{4}{$f(x_n) \rightarrow f(l)$}
