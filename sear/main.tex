...
Let $A$ be a set. Let $f : \mathcal{P} A \rightarrow A$. Then there exists a unique $g : \mathbb{N} \rightarrow A$ such that, for all $n \in \mathbb{N}$, we have
\[ g(n) = f(\{ g(m) : m < n \}) \enspace . \]
\end{thm}
