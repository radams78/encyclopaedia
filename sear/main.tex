...
The \emph{uniform metric} $\overline{\rho}$ on $\mathbb{R}^\omega$ is defined by
\[ \overline{\rho}((x_n),(y_n)) = \sup_{n \in \mathbb{N}} \overline{d}(x_n,y_n) \]
...
\begin{proof}
	\pf
	\begin{align*}
		\overline{\rho}(x,y) & = \sup_n \overline{d}(x_n,y_n) \\
		& \geq \overline{d}(x_0,y_0) \\
		& \geq 0
	\end{align*}
\end{proof}
...
\begin{proof}
	\pf
	\begin{align*}
		\overline{\rho}(x,y) = 0 & \Leftrightarrow \sup_n \overline{d}(x_n,y_n) = 0 \\
		& \Leftrightarrow \forall n. \overline{d}(x_n,y_n) = 0 \\
		& \Leftrightarrow \forall n. x_n = y_n \\
		& \Leftrightarrow x = y
	\end{align*}
\end{proof}
...
\begin{proof}
	\pf
	\begin{align*}
		\overline{\rho}(x,z) & = \sup_n \overline{d}(x_n,z_n) \\
		& \leq \sup_n (\overline{d}(x_n,y_n) + \overline{d}(y_n,z_n)) \\
		& \leq \sup_n \overline{d}(x_n,y_n) + \sup_n \overline{d}(y_n,z_n) \\
