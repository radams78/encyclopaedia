...
\end{proof}
\step{2}{\pick\ $a \in A$}
\step{3}{\pick\ a set $S$ and injection $i : S \rightarrowtail A$ such that, for all $x \in A$, there exists $s \in S$ such that $s = x$ if and only if $x = a$}
...
%TODO This is the converse to an earlier proposition
\begin{prop}
...
\begin{proof}
\pf
\step{1}{For all $\mathcal{U} \subseteq \mathcal{T}_0$ we have $\bigcup \mathcal{U} \in \mathcal{T}_0$.}
\begin{proof}
	\step{a}{\pflet{$\mathcal{U} \subseteq \mathcal{T}_0$}}
	\step{b}{\pflet{$\mathcal{V} = \{ U \text{ open in } X : U \cap X_0 \in \mathcal{U} \}$.}}
	\step{c}{$\bigcup \mathcal{V}$ is open in $X$. \prove{$\bigcup \mathcal{U} = \bigcup \mathcal{V} \cap X_0$}}
	\step{d}{$\bigcup \mathcal{U} \subseteq \bigcup \mathcal{V} \cap X_0$}
	\begin{proof}
		\step{i}{\pflet{$x \in \bigcup \mathcal{U}$}}
		\step{ii}{\pick\ $U \in \mathcal{U}$ such that $x \in U$}
		\step{iii}{\pick\ $V$ open in $X$ such that $U = V \cap X_0$}
		\step{iv}{$x \in V \in \mathcal{V}$}
		\step{v}{$x \in \bigcup \mathcal{V}$}
	\end{proof}
	\step{e}{$\bigcup \mathcal{V} \cap X_0 \subseteq \bigcup \mathcal{U}$}
	\begin{proof}
		\step{i}{\pflet{$x \in \bigcup \mathcal{V} \cap X_0$}}
		\step{ii}{\pick\ $V \in \mathcal{V}$ such that $x \in V$}
		\step{iii}{$x \in V \cap X_0 \in \mathcal{U}$}
		\step{iv}{$x \in \bigcup \mathcal{U}$}
	\end{proof}
\end{proof}
\step{2}{For all $U,V \in \mathcal{T}_0$ we have $U \cap V \in \mathcal{T}_0$.}
\begin{proof}
	\step{a}{\pflet{$U,V \in \mathcal{T}_0$}}
	\step{b}{\pick\ $U'$, $V'$ open in $X$ such that $U = U' \cap X_0$ and $V = V' \cap X_0$}
	\step{c}{$U \cap V = (U' \cap V') \cap X_0$}
	\step{d}{$U \cap V \in \mathcal{T}_0$}
\end{proof}
\step{3}{$X_0 \in \mathcal{T}_0$}
\begin{proof}
...
Let $X$ and $Y$ be topological spaces. Let $f : X \rightarrow Y$. Let $A$ and $B$ be closed subspaces of $X$ such that $X = A \cup B$. If $f \restriction A : A \rightarrow Y$ and $f \restriction B : B \rightarrow Y$ are continuous then $f$ is continuous.
\end{thm}

\begin{proof}
\pf
\step{1}{\pflet{$C$ be closed in $Y$.}}
\step{2}{$\inv{f}(C) = \inv{f \restriction A}(C) \cup \inv{f \restriction B}(C)$}
...
\begin{proof}
\pf
\step{1}{\pflet{$X$ and $Y$ be Hausdorff spaces.}}
\step{2}{\pflet{$(x_1,y_1),(x_2,y_2) \in X \times Y$ with $(x_1,y_1) \neq (x_2,y_2)$}}
\step{3}{\assume{w.l.o.g. $x_1 \neq x_2$}}
\step{4}{\pick\ disjoint open sets $U$, $V$ in $X$ with $x_1 \in U$ and $x_2 \in V$.}
\step{5}{$U \times Y$ and $V \times Y$ are disjoint open sets in $X \times Y$ with $(x_1,y_1) \in U \times Y$ and $(x_2,y_2) \in V \times Y$.}
\qed
\end{proof}
